...
- Use `esc_theme()` at the end of your plot code. 
...
```{r theme61-colours, echo = FALSE, out.width='100%'}
p
```

The `esc_palette` function provides you with `n` base colours in coloumn '0' plus three additional secondary colours.
...
g#knitr::include_graphics("../man/figures/g-line.svg")
```
...
```{r, echo=FALSE, out.width='100%'}
g#knitr::include_graphics("../man/figures/g-col.svg")
```
...
```{r, echo=FALSE, out.width='100%'}
g#knitr::include_graphics("../man/figures/g-scatter.svg")
```
...
```{r, echo=FALSE, out.width='100%'}
g#knitr::include_graphics("../man/figures/g-facet.svg")
```
...
```{r, echo=FALSE, out.width='100%'}
g#knitr::include_graphics("../man/figures/g-dens.svg")
```
...
Horizontal bar graphs made with `coord_flip()` require some changes to the `theme()` in order to look proper. `format_flip` wraps those changes up in a convenient function that should be appended at the end of the graph code, after theming functions such as `esc_theme()` have been called.
